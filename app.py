...
with col1:
    ...
    if not st.session_state.df_sorted.empty:
        ...
        st.write(f"💬 Jag hittade {count} relevanta jobb för '{user_input}'{city_text}. Här är några exempel: {'; '.join(examples)}. Vill du se fler detaljer om något av dessa jobb, klicka på länken under varje annons.")
